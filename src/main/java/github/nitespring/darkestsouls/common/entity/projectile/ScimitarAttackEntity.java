...
public class ScimitarAttackEntity extends Entity{
	@Nullable
	...
	private static final EntityDataAccessor<Integer> ANIMATIONSTATE = SynchedEntityData.defineId(ScimitarAttackEntity.class, EntityDataSerializers.INT);

	public ScimitarAttackEntity(EntityType<?> p_19870_, Level p_19871_) {
		super(p_19870_, p_19871_);

	}
	public ScimitarAttackEntity(EntityType<?> p_19870_, Level p_19871_, Vec3 pos, float dmg, float rot) {
