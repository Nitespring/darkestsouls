...
public class HollowSoldierAxe extends Hollow implements GeoEntity {
    ...
    public HollowSoldierAxe(EntityType<? extends PathfinderMob> p_21683_, Level p_21684_) {
        ...
        if(this.isDeadOrDying()) {
            ...
            switch(animState) {
                ...
                case 21:
                    ...
                    break;
                case 22:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.hollow.axe.attack2"));
                    break;
                case 23:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.hollow.axe.attack3"));
                    break;
                case 24:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.hollow.axe.attack4"));
                    break;
                case 25:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.hollow.axe.attack5"));
                    break;
                case 31:
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new HollowSoldierAxe.AttackGoal(this));
        this.goalSelector.addGoal(2, new HollowSoldierAxe.AttackGoalRunning(this));
    ...
    public class AttackGoal extends Goal {
        ...
        protected final HollowSoldierAxe mob;
        private Path path;
        ...
        public AttackGoal(HollowSoldierAxe entityIn) {
            this.mob = entityIn;
    ...
    public class AttackGoalRunning extends Goal {
        ...
        public AttackGoalRunning(HollowSoldierAxe entityIn) {
            this.mob = entityIn;
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK));
        }
