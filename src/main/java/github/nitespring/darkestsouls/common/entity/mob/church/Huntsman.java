...
public abstract class Huntsman extends DarkestSoulsAbstractEntity {
    ...
    protected void defineSynchedData() {
        ...
        this.getEntityData().define(ROBE_TYPE, this.getDefaultRobeType());
        this.getEntityData().define(HAT_TYPE, this.getDefaultHatType());
        this.getEntityData().define(HAIR_TYPE, this.getDefaultHairType());
        this.getEntityData().define(SHIRT_TYPE, this.getDefaultShirtType());
        this.getEntityData().define(RIGHT_HAND, ItemStack.EMPTY);
        this.getEntityData().define(LEFT_HAND, ItemStack.EMPTY);
    }
