...
public class ChurchDoctorLantern extends ChurchDoctor implements GeoEntity {
    ...
    public ChurchDoctorLantern(EntityType<? extends PathfinderMob> p_21683_, Level p_21684_) {
    ...
    private <E extends GeoAnimatable> PlayState predicate(AnimationState<E> event) { /*if(this.shouldResetAnimation()){
        ...
        if(this.isDeadOrDying()) {
            event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.church_doctor.lantern.death"));
        }else {
            switch(animState) {
                case 1:
                    ...
                    break;
                case 21:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.church_doctor.lantern.attack"));
                    break;
                case 22:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.church_doctor.lantern.attack1"));
                    break;
                case 23:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.church_doctor.lantern.attack2"));
                    break;
                default:
                    if(this.isInWater()) {
                        ...
                        event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.church_doctor.lantern.walk"));
                    }else {
                        event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.church_doctor.lantern.idle"));
                    }
                    break;
            }
        }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new ChurchDoctorLantern.AttackGoal(this));
