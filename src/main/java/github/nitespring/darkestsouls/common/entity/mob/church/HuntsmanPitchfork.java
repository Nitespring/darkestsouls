...
public class HuntsmanPitchfork extends Huntsman implements GeoEntity {
    ...
    public HuntsmanPitchfork(EntityType<? extends PathfinderMob> p_21683_, Level p_21684_) {
        ...
        if(this.isDeadOrDying()) {
            ...
            switch(animState) {
                case 1:
                    ...
                    break;
                case 21:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.huntsman.pitchfork.atk1"));
                    break;
                case 22:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.huntsman.pitchfork.atk2"));
                    break;
                case 23:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.huntsman.pitchfork.atk3"));
                    break;
                case 24:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.huntsman.pitchfork.atk4"));
                    break;
                case 25:
                    event.getController().setAnimation(RawAnimation.begin().thenPlay("animation.huntsman.pitchfork.atk5"));
                    break;
                case 31:
                ...
                default:
                    if(this.isInWater()) {
                        ...
                        event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.huntsman.pitchfork.fall"));

                    }else if(!(event.getLimbSwingAmount() > -0.06 && event.getLimbSwingAmount() < 0.06f)){
                        if(getCombatState()==1) {
                            event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.huntsman.pitchfork.run"));
                        }else{
                            if(isAggressive()) {
                                event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.huntsman.pitchfork.walk_aggressive"));
                            }else{
                                event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.huntsman.pitchfork.walk"));
                            }
                        }
                    }else {
                        if(isAggressive()) {
                            event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.huntsman.pitchfork.idle_aggressive_fast"));
                        }else{
                            event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.huntsman.pitchfork.idle"));
                        }
                    }
                    break;
            }
    ...
    public ItemStack getRightHandItem() {
        return ItemInit.HUNTSMAN_PITCHFORK.get().getDefaultInstance();
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new HuntsmanPitchfork.AttackGoal(this));
            ...
            case 21:
                ...
                if(getAnimationTick()==7) {
                    ...
                    DamageHitboxEntity h = new DamageHitboxEntity(EntityInit.HITBOX.get(), level(),
                            this.position().add((1.25f)*this.getLookAngle().x,
                                    0.25,
                                    (1.25f)*this.getLookAngle().z),
    ...
    public class AttackGoal extends Goal {
        ...
        private final double walkingSpeedModifier = 1.3f;
        private final double runningSpeedModifier = 1.9f;
        ...
        protected void checkForAttack(double distance, double reach){
            if (distance <= reach && this.ticksUntilNextAttack <= 0) {
                ...
                if(r<=480)      {this.mob.setAnimationState(22);}
                else if(r<=720) {this.mob.setAnimationState(23);}
                else if(r<=960){this.mob.setAnimationState(24);}
                else if(r<=1200){this.mob.setAnimationState(25);}
            }
