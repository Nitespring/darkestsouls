...
public abstract class SpawnGroupEntity extends DarkestSoulsAbstractEntity{
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData, CompoundTag tag) {
        ...
        this.doMobSpawns(level, difficulty, spawnType, spawnGroupData, tag);
        //this.discard();
    ...
    public abstract void doMobSpawns(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData, CompoundTag tag);
