...
public abstract class TrickWeapon extends Weapon implements ITransformableItem{
    ...
    public void appendHoverText(ItemStack stack, Level context, List<Component> tooltip, TooltipFlag p_41424_) {
        ...
        tooltip.add(Component.translatable("translation.darkestsouls.trick1").append(Component.translatable(KeybindInit.TRICK_KEYBIND.getKey().getName())).append(Component.translatable("translation.darkestsouls.trick2")).withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.DARK_GRAY));
