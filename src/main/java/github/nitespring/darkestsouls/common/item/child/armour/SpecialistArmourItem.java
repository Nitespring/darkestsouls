...
public class SpecialistArmourItem extends CustomArmourItem {
    ...
    public @Nullable ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
        ...
        return innerModel ? new ResourceLocation(DarkestSouls.MODID , "textures/armour/specialist_armour_1_inner.png") : new ResourceLocation(DarkestSouls.MODID , "textures/armour/specialist_armour_1_outer.png");
    }
