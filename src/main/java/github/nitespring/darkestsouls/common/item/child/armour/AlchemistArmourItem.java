...
public class AlchemistArmourItem extends CustomArmourItem {
    ...
    public @Nullable ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
        ...
        return innerModel ? new ResourceLocation(DarkestSouls.MODID , "textures/armour/alchemist_armour_top_hat_inner.png") : new ResourceLocation(DarkestSouls.MODID , "textures/armour/alchemist_armour_top_hat_outer.png");
    }
