...
public class Falchion extends Weapon {
    ...
    public Falchion(Tier tier, float attack, float speed, float knockback,int poise, int durability,int enchantability, float movementSpeed, int maxTargets, Properties properties) {
