...
public class Claymore extends Weapon{
    ...
    public Claymore(Tier tier, float attack, float speed, float knockback, int durability, int enchantability, float movementSpeed, int maxTargets, Properties properties) {
