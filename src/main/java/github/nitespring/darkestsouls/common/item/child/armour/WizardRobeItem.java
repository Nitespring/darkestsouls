...
public class WizardRobeItem extends CustomArmourItem {
    ...
    public @Nullable ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
        ...
        return innerModel ? new ResourceLocation(DarkestSouls.MODID , "textures/armour/wizard_robes_inner.png") : new ResourceLocation(DarkestSouls.MODID , "textures/armour/wizard_robes.png");
    }
    ...
    private static final class ArmorRender implements IClientItemExtensions {
        ...
        public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel<?> model) {
            ...
            ModelPart root = models.bakeLayer(slot == EquipmentSlot.LEGS ? ClientListener.WIZARD_ROBE_INNER : ClientListener.WIZARD_ROBE);
            WizardRobeModel aModel = new WizardRobeModel(root);
            return aModel;
        }
