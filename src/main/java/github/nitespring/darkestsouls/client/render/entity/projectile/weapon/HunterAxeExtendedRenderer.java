...
public class HunterAxeExtendedRenderer<T extends WeaponAttackEntity> extends EntityRenderer<T>{
	...
	public HunterAxeExtendedRenderer(Context context) {
		super(context);
