...
public class SawCleaverExtendedRenderer<T extends WeaponAttackEntity> extends EntityRenderer<T>{
	...
	public SawCleaverExtendedRenderer(Context context) {
		super(context);
