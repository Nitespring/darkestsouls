...
public class BanditKnifeRenderer<T extends WeaponAttackEntity> extends EntityRenderer<T>{
	...
	public BanditKnifeRenderer(Context context) {
		super(context);
