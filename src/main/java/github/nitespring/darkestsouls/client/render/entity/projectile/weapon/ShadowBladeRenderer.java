...
public class ShadowBladeRenderer<T extends WeaponAttackEntity> extends EntityRenderer<T>{
	...
	public static final ResourceLocation TEXTURE_LOCATION_2 = new ResourceLocation(DarkestSouls.MODID, "textures/entity/weapons/grave_scythe/grave_scythe_1.png");

	public static final ResourceLocation TEXTURE_LOCATION_3 = new ResourceLocation(DarkestSouls.MODID, "textures/entity/weapons/grave_scythe/grave_scythe_2.png");
	public static final ResourceLocation TEXTURE_LOCATION_4 = new ResourceLocation(DarkestSouls.MODID, "textures/entity/weapons/grave_scythe/grave_scythe_3.png");
	public static final ResourceLocation TEXTURE_LOCATION_5 = new ResourceLocation(DarkestSouls.MODID, "textures/entity/weapons/grave_scythe/grave_scythe_4.png");
	public static final ResourceLocation TEXTURE_LOCATION_6 = new ResourceLocation(DarkestSouls.MODID, "textures/entity/weapons/grave_scythe/grave_scythe_5.png");
	public static final ResourceLocation TEXTURE_LOCATION_7 = new ResourceLocation(DarkestSouls.MODID, "textures/entity/weapons/grave_scythe/grave_scythe_6.png");
	public static final ResourceLocation TEXTURE_LOCATION_8 = new ResourceLocation(DarkestSouls.MODID, "textures/entity/weapons/grave_scythe/grave_scythe_7.png");
