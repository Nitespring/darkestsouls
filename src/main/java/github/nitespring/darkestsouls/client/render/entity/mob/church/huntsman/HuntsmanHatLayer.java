...
public class HuntsmanHatLayer<T extends Huntsman & GeoEntity> extends GeoRenderLayer<T>{
	...
	private static final ResourceLocation BLACK = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hat/huntsman_hat_black.png");
	private static final ResourceLocation TOP_HAT_BLACK = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hat/huntsman_top_hat_black.png");
	private static final ResourceLocation TOP_HAT_WHITE = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hat/huntsman_top_hat_white.png");
	private static final ResourceLocation TOP_HAT_GRAY = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hat/huntsman_top_hat_gray.png");
	public static final ResourceLocation NO_HAT = new ResourceLocation(DarkestSouls.MODID, "textures/entity/weapons/frayed_blade/frayed_blade0.png");
