...
public class HuntsmanHairLayer<T extends Huntsman & GeoEntity> extends GeoRenderLayer<T>{
	...
	private static final ResourceLocation BLACK = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hair/huntsman_hair_black.png");
	private static final ResourceLocation BROWN = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hair/huntsman_hair_brown.png");
	private static final ResourceLocation DARK_BROWN = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hair/huntsman_hair_dark_brown.png");
	private static final ResourceLocation GRAY = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hair/huntsman_hair_grey.png");
	private static final ResourceLocation BLONDE = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hair/huntsman_hair_blonde.png");
	private static final ResourceLocation RED = new ResourceLocation(DarkestSouls.MODID, "textures/entity/church/huntsman/hair/huntsman_hair_red.png");
