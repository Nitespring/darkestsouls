...
public class SkeletonSpearGeoRenderer<T extends SkeletonSpear> extends GeoEntityRenderer<T>{

	public SkeletonSpearGeoRenderer(EntityRendererProvider.Context renderManager)
    {
